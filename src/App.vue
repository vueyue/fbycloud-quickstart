...
<template>
  <div class="container">
      ...
      <div class="list">
        ...
        <div class="list_item">
          <div class="list_item-head">
            <van-checkbox class="checkbox-base" checked-color="#75A8F7" v-model="radio">核对证据原件并存档</van-checkbox>
        ...
        <div class="list_item list_item--blue">
          <div class="list_item-head">
            <van-checkbox class="checkbox-base" checked-color="#75A8F7" v-model="radio1" shape="square">调取并查阅案卷</van-checkbox>
            <div class="list_item-head_name">
              <div class="list_item-head_name-tag"></div>
              <div class="list_item-head_name-text">e租宝案</div>
            </div>
        ...
        <div class="list_item list_item--orange">
          <div class="list_item-head">
            <van-checkbox class="checkbox-base" checked-color="#75A8F7" v-model="radio2" shape="square">领取传票并通知委托人</van-checkbox>
            <div class="list_item-head_name">
              <div class="list_item-head_name-tag"></div>
              <div class="list_item-head_name-text">e租宝案</div>
            </div>
        ...
        <div class="list_item list_item--red">
          <div class="list_item-head">
            <van-checkbox class="checkbox-base" checked-color="#75A8F7" v-model="radio3" shape="square">写委托书</van-checkbox>
            <div class="list_item-head_name">
              <div class="list_item-head_name-tag"></div>
              <div class="list_item-head_name-text">e租宝案</div>
            </div>
    ...
    <van-tabbar v-model="active" class="foot-base">
      <van-tabbar-item class="item-base" icon="comment-o">名片夹</van-tabbar-item>
      <van-tabbar-item class="item-base" icon="shop-o">官网</van-tabbar-item>
      <van-tabbar-item class="item-base" icon="user-o">我的</van-tabbar-item>
    </van-tabbar>
  </div>
</template>
